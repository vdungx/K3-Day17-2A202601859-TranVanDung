...
def write_batch(con: duckdb.DuckDBPyConnection, batch: list[dict]) -> None:
    ...
    Mỗi batch được ghi bằng một câu lệnh multi-row upsert. Replay cùng một
    event_id sẽ cập nhật payload hiện tại thay vì tạo thêm hàng trùng.
    """
    ...
    # Offset chỉ được commit sau khi batch đã bền vững trong DuckDB.
    con.commit()
